class JirosController < ApplicationController
  def show
    ...
    @table_seasonings = [@facility.seasoning1, @facility.seasoning2, @facility.seasoning3, @facility.seasoning4, @facility.seasoning5,
                         @facility.seasoning6]
    @main_menu = jiro.menu.main_menu
    @option_menu = jiro.menu.option_menu
